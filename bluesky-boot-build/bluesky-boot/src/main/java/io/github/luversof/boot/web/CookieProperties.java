...
public class CookieProperties
    extends AbstractBlueskyProperties<CookieProperties, CookieProperties.CookiePropertiesBuilder>
  ...
  public static final String DEFAULT_BEAN_NAME =
      "bluesky-boot.web.cookie-io.github.luversof.boot.web.CookieProperties";
  public static final String EXTERNAL_COOKIE_BEAN_NAME =
      "bluesky-boot.web.external-cookie-io.github.luversof.boot.web.ExternalCookieProperties";
  ...
  public int hashCode() {
    return Objects.hash(
        super.hashCode(), beanName, name, maxAge, domain, path, secure, httpOnly, sameSite);
  }
  ...
  public static class CookiePropertiesBuilder
      implements BlueskyPropertiesBuilder<CookieProperties> {
    ...
    public CookieProperties build() {
      return new CookieProperties(beanName, name, maxAge, domain, path, secure, httpOnly, sameSite);
    }
  }
}
