...
public abstract class AbstractLocaleResolveHandler implements LocaleResolveHandler {
     ...
     * set localeContext
     *
     * @param localeResolveInfo An object containing information related to locale resolve
     *     processing.
     * @param localeResolveInfoContainer Passed in case of referencing the preceding
     *     localeResolveInfo
     */
    protected void setResolveLocale(
            LocaleResolveInfo localeResolveInfo,
        ...
        if (PreLocaleResolveInfoCondition.USE_FIRST.equals(preLocaleResolveInfoCondition)
                || PreLocaleResolveInfoCondition.USE_LANGUAGE_FIRST.equals(
        ...
        if (PreLocaleResolveInfoCondition.USE_WHEN_NOT_RESOLVED.equals(
                        preLocaleResolveInfoCondition)
    ...
    protected void setRepresenatativeSupplier(
            ...
            LocaleResolveInfo localeResolveInfo) {
        var localeResolveHandlerProperties = getLocaleResolveHandlerProperties();
        var setRepresentativeCondition =
                localeResolveHandlerProperties.getSetRepresentativeCondition();
    ...
    protected Locale getResolveLocaleByPreResolveInfo(
        ...
        var preResolveLocale =
                CollectionUtils.isEmpty(resolveList)
                        ? null
                        : resolveList.getLast().getResolveLocale();
