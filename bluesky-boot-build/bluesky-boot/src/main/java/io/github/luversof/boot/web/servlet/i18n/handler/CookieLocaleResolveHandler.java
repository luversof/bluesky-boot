...
public class CookieLocaleResolveHandler extends AbstractLocaleResolveHandler {
	...
	public CookieLocaleResolveHandler(String localePropertiesBeanName, String cookiePropertiesBeanName,
	...
	private Locale getRequestLocale(HttpServletRequest request) {
		...
		try {
			...
			log.debug(
					"Ignoring invalid locale cookie '" + cookieName + "': [" + value + "] due to: " + ex.getMessage());
		}
