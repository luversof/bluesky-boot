...
public class BlueskyErrorMessage implements ErrorMessage {
  ...
  public BlueskyErrorMessage setErrorMessageArgs(Object[] errorMessageArgs) {
    if (errorMessageArgs != null && errorMessageArgs.length > 0) {
      this.errorMessageArgs =
          Arrays.stream(errorMessageArgs)
  ...
  public boolean equals(Object o) {
    ...
    return isDisplayableMessage == that.isDisplayableMessage
  ...
  public int hashCode() {
    int result =
        Objects.hash(errorCode, exceptionClassName, isDisplayableMessage, message, object, field);
