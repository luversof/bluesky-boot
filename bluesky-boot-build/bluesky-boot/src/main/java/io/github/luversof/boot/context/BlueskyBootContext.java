 ...
 * BlueskyContext is created per request, while BlueskyBootContext persists
...
public class BlueskyBootContext {
	...
	/**
	 * moduleName 전체 목록
	 * CoreBaseProperties에 설정된 moduleNameSet 과 coreProperties로 설정한 moduleName 을 합하여
	 * 이 moduleNameSet이 설정됨.
	 ...
	 * DevTools RestartClassLoader 오류로 인해 BlueskyResfreshProperties가 아닌 Serializable
	 * 로 정의
