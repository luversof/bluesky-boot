...
public class BlueskyBootContext {
    ...
    /**
     * moduleName 전체 목록 CoreBaseProperties에 설정된 moduleNameSet 과 coreProperties로 설정한 moduleName 을 합하여
     * 이 moduleNameSet이 설정됨. 설정된 moduleNameSet을 기준으로 BlueskyProperties를 구현한 여러 properties의 module을
     * 생성함
     */
