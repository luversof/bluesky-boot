...
public class LocaleResolveHandlerProperties
  ...
  /**
   * 대표 로케일 지정 조건 NONE : 대표 로케일로 지정하지 않음 OVERWRITE : 무조건 지정, OVERWRITE_WHEN_NOT_EXISTS : 이미 존재하는 대표
   * 로케일의 resolveLocale이 없으면 지정 SKIP_IF_EXISTS : 이미 존재하는 대표 로케일이 있으면 넘어감 (이렇게 쓸일은 없을 듯)
   */
