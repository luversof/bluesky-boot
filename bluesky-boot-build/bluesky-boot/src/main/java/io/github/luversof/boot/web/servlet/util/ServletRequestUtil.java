...
public final class ServletRequestUtil {
  ...
  public static String getRemoteAddr() {
    ...
    log.debug(
        "ServletRequestUtil.getRemoteAddr() : remoteAddr : {},x-forwarded-for : {}",
  ...
  /**
   * 내부 요청인 경우 체크 serverName이 도메인이 아닌 ip 형태인 경우 내부 효출로 판단함
   *
   * @return
   */
  ...
  /**
   * url에 등록된 pathVariable을 조회하는 기능 일반적으로 interceptor 이후엔 requestAttribute에서 직접 꺼내 사용하면 되며
