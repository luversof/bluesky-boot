...
public class DomainProperties
        extends AbstractBlueskyProperties<
                DomainProperties, DomainProperties.DomainPropertiesBuilder> {
    ...
    /**
     * When using multi-modules, if you make an add-path-pattern declaration, you need an
     * addPathPatterns declaration for each module.
     *
     * <p>Registering the AntPathMatcher Pattern
     */
     ...
     *
     * <p>If your site doesn't have a PC web/mobile web distinction, declare only WEB and use it.
     */
     ...
     *
     * <p>Mobile web address must be declared if there is a PC web/mobile web distinction
     *
     * <p>Used separately in unified notification processing
     */
    private List<URI> mobileWebList = new ArrayList<>();

    /**
     * When declared and used by domain in a multi-module project, the domain is a variable for
     * local development that is set aside for development purposes.
     *
     * <p>You can use development domains in the form of a list by declaring them in succession with
     * ",".
     *
     * <p>ex) devDomainList=http://local.a.com,http://local.b.com
     */
    private List<URI> devDomainList = new ArrayList<>();

    /** List of static paths (not redirect targets) */
    private List<String> staticPathList =
            Arrays.asList(
                    "/css/",
                    "/html/",
                    "/js/",
    ...
    public DomainProperties(
            List<String> addPathPatternList,
            List<URI> webList,
            List<URI> mobileWebList,
            List<URI> devDomainList,
            List<String> staticPathList,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(addPathPatternList, that.addPathPatternList)
                && Objects.equals(webList, that.webList)
                ...
                && Objects.equals(forwardPath, that.forwardPath);
    }
     ...
     *
     * <p>If your site doesn't have a PC web/mobile web distinction, declare only WEB and use the
     */
    ...
    protected BiConsumer<DomainProperties, DomainPropertiesBuilder> getPropertyMapperConsumer() {
        return (properties, builder) -> {
            ...
            propertyMapper
                    .from(properties::getWebList)
                    .whenNot(x -> x == null || x.isEmpty())
                    .to(builder::webList);
            propertyMapper
                    .from(properties::getMobileWebList)
                    .whenNot(x -> x == null || x.isEmpty())
                    .to(builder::mobileWebList);
            propertyMapper
                    .from(properties::getDevDomainList)
                    .whenNot(x -> x == null || x.isEmpty())
                    .to(builder::devDomainList);
            propertyMapper
                    .from(properties::getStaticPathList)
                    .whenNot(x -> x == null || x.isEmpty())
                    .to(builder::staticPathList);
            propertyMapper
                    .from(properties::getExcludePathList)
                    .whenNot(x -> x == null || x.isEmpty())
    ...
    protected DomainPropertiesBuilder getBuilder() {
        ...
        return parentModuleInfo == null
                ...
                : parentModuleInfo.getDomainPropertiesBuilder();
    }
    ...
    public static class DomainPropertiesBuilder
            implements BlueskyPropertiesBuilder<DomainProperties> {
