...
public class UuidGeneratorModuleProperties
  ...
  protected UuidGeneratorProperties.UuidGeneratorPropertiesBuilder getBuilder(String moduleName) {
    ...
    return moduleInfoMap.containsKey(moduleName)
        ? moduleInfoMap.get(moduleName).getUuidGeneratorPropertiesBuilder()
  ...
  public String toString() {
    return "UuidGeneratorModuleProperties{" + "parent=" + parent + ", modules=" + modules + '}';
  }
}
