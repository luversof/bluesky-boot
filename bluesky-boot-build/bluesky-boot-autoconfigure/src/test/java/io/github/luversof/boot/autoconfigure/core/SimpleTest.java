...
class SimpleTest {
    ...
    void messageCodeResolveTest() {
        ...
        String[] codes =
                codeResolver.resolveMessageCodes("NotBlank", "someObjectName", "someField", null);
    ...
    private static Stream<Arguments> provideStringsForIsBlank() { // argument source method
        return Stream.of(
                ...
                Arguments.of("", true), Arguments.of("  ", true), Arguments.of("not blank", false));
    }
    ...
    static class TestProperties {
        ...
        public TestProperties(
                boolean enabled, boolean enabled2, Boolean enabled3, Boolean enabled4) {
