...
class RedisAutoConfigurationTests {
        ...
        this.contextRunner.run(
                context -> {
                    assertThat(context.getBean("redisTemplate"))
                            .isInstanceOf(RedisOperations.class);
    ...
    void testRedisUrlConfiguration() {
        this.contextRunner
                .withPropertyValues(
                        "spring.redis.host:foo",
                        "spring.redis.url:redis://user:password@example:33") // NOSONAR
                // secrets:S6739
                .run(
                        context -> {
                            LettuceConnectionFactory cf =
        ...
        this.contextRunner
                ...
                .run(
                        context -> {
                            ...
                            assertThat(poolConfig.getMaxWaitDuration())
        ...
        this.contextRunner
                ...
                .run(
                        context -> {
                            ...
                            assertThat(sentinelConfiguration.getSentinelPassword().isPresent())
                                    .isFalse();
                        ...
                        context -> {
                            ...
                            assertThat(clusterConfiguration.getClusterNodes())
                                    ...
                                    .containsExactlyInAnyOrder(
                                            "127.0.0.1:27379", "127.0.0.1:27380");
                        });
    }
    ...
    void testRedisConfigurationCreateClientOptionsByDefault() {
        this.contextRunner.run(
                assertClientOptions(
                        ClientOptions.class,
                        options -> {
                            assertThat(options.getTimeoutOptions().isApplyConnectionTimeout())
                                    .isTrue();
                        ...
                        assertClientOptions(
                                ...
                                options -> {
                                    assertThat(
                                            ...
                                            .isTrue();
                                    assertThat(options.getTimeoutOptions().isTimeoutCommands())
                                            .isTrue();
                                }));
    }
        ...
        this.contextRunner
                ...
                .run(
                        assertClientOptions(
                                ClientOptions.class,
                                options ->
                                        assertThat(options.getClass())
                                                .isEqualTo(ClientOptions.class)));
    }
