...
public class BlueskyBootPropertiesMigrationListener
        implements ApplicationListener<SpringApplicationEvent> {

    private static final Log logger =
            LogFactory.getLog(BlueskyBootPropertiesMigrationListener.class);
    ...
    private void onApplicationStartedEvent(ApplicationStartedEvent event) {
        ...
        BlueskyBootPropertiesMigrationReporter reporter =
                new BlueskyBootPropertiesMigrationReporter(
                        repository, event.getApplicationContext().getEnvironment());
