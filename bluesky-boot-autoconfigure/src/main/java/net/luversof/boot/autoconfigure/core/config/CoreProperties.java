...
public class CoreProperties implements BlueskyCoreProperties<net.luversof.boot.autoconfigure.core.config.CoreProperties.CoreModuleProperties>, InitializingBean {
